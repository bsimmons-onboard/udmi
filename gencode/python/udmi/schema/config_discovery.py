...
class Object1DB690B5:
  ...
  def from_dict(source):
    if not source:
      return None
    result = Object1DB690B5()
    result.families = source.get('families')
    result.point_refs = source.get('point_refs')
  ...
  def map_from(source):
    ...
    result = {}
    for key in source:
      result[key] = Object1DB690B5.from_dict(source[key])
    return result
  ...
  def to_dict(self):
    ...
    if self.point_refs:
      result['point_refs'] = self.point_refs # 5
    if self.features:
...
class DiscoveryConfig:
  ...
  def from_dict(source):
    ...
    result.enumerate = Object1DB690B5.from_dict(source.get('enumerate'))
